...
L["RUNECARVING_SLOT_HEADER"] = _G.RUNEFORGE_LEGENDARY_POWER_TOOLTIP_SLOT_HEADER
...
L["CURRENCY_THRESHOLD_DESC"] = "Use |cffffd200-1|r to ignore the currency, |cffffd2000|r to disable the filter, or |cffffd200any number above 0|r to set the threshold below which no toasts will be created."
