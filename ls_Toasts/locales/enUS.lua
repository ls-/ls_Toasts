...
L["RUNECARVING_SLOT_FORMAT"] = _G.RUNEFORGE_LEGENDARY_POWER_TOOLTIP_SLOT_HEADER:format("|cffffffff%s|r")
L["RUNECARVING_SOURCE_FORMAT"] = _G.RUNEFORGE_LEGENDARY_POWER_SOURCE_FORMAT:format("|cffffffff%s|r")
L["RUNECARVING_SPEC_FORMAT"] = _G.RUNEFORGE_LEGENDARY_POWER_REQUIRES_SPEC_FORMAT:format("|cffffffff%s|r")
